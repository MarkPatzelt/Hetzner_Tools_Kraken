...
bit.trading_pair = 'XXBTZEUR'              #trading pair
bit.side = "sell"
bit.trade_type = "market"                    #change this to "market" if you need to sell quickly - careful, you will be a market taker!
bit.sell_cycles = 3                       #max packet size
bit.time_cycle = 20                         #time interval between order placements
...
bit.trailing_stop_loss_percentage = 0.97
bit.trailing_stop_loss_fixed_value = 0.000002
bit.stop_loss_exit_level = 8400
